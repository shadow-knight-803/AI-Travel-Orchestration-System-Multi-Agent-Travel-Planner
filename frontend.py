...
st.set_page_config(page_title="AI Travel Orchestration System — A Multi-Agent Travel Planner", layout="wide")

st.title("AI Travel Orchestration System — A Multi-Agent Travel Planner")
