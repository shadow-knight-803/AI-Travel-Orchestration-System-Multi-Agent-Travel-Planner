...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": r"D:\Shadow_Knight\AI_Travel_Orchestration_System\aviationstack-mcp\.venv\Scripts\python.exe",
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
        ...
        "weather": {
            "transport": "stdio",
            "command": r"D:\Shadow_Knight\AI_Travel_Orchestration_System\.venv\Scripts\python.exe",
            "args": [
                r"D:\Shadow_Knight\AI_Travel_Orchestration_System\weather_mcp_server.py"
            ],
            "env": {
